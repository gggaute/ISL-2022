...
class SetsSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ('id', 'title', 'description', 'forstaelse1', 'forstaelse2', 'forstaelse3', 'forstaelse4',
                  ...
                  'ryddeSetninger5', 'DraInnManglendeOrd1', 'DraInnManglendeOrd2', 'DraInnManglendeOrd3', 'DraInnManglendeOrd4',
                  'DraInnManglendeOrd5', 'LåsOppMobil1', 'LåsOppMobil2', 'LåsOppMobil3', 'LåsOppMobil4',
                  'LåsOppMobil5')
